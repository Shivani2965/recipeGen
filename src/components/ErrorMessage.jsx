...
const ErrorMessage = ({
  ...
  const isKeyError = message.includes("SPOONACULAR_API_KEY") || message.includes("API key") || showKeySetupHint;
  return <div
  ...
  >
      <div className="flex items-start gap-3.5">
        ...
        <div className="flex-1 text-left">
          ...
          {isKeyError && <div className="mt-3 p-3 bg-white/80 rounded-xl border border-amber-200/70 text-xs text-stone-600 space-y-1">
