      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-1.5 mb-2">
            ...
            {calories && (
              <span className="inline-flex items-center gap-0.5 px-2 py-0.5 rounded-md bg-orange-50 text-orange-800 text-[11px] font-medium">
                <Flame className="w-3 h-3 text-orange-500" />
                {calories}
              </span>
            )}
            {tags.slice(0, 1).map((t) => (
              <span key={t} className="px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-800 text-[11px] font-medium">
                {t}
              </span>
            ))}
          </div>
