...
import { User, Mail, Calendar, Heart, Bookmark, LogOut, Check, Sparkles } from 'lucide-react';
...
export const Profile: React.FC = () => {
  ...
  return (
    <div id="profile-page" className="min-h-screen bg-stone-50 py-10 px-4 sm:px-6 lg:px-8">
