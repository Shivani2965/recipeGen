...
import { ChefHat, Mail, Lock, ArrowRight, Sparkles, UserCheck } from 'lucide-react';
...
export const Login: React.FC = () => {
  ...
  // Check if routed with custom message (e.g. from favoriting or saving while logged out)
