...
import { SlidersHorizontal, ChefHat, RotateCcw } from "lucide-react";
...
const Explore = () => {
  ...
  useEffect(() => {
    ...
    if (searchResults.length === 0 && !loading) {
      executeSearch(
        void 0,
        queryParam || void 0,
        tagsParam ? { ...filters, ...tagsParam.includes("quick") ? { maxReadyTime: 30 } : {} } : void 0
      );
    }
  }, []);
  ...
  return <div id="explore-page-container" className="min-h-screen bg-stone-50 py-8 px-4 sm:px-6 lg:px-8">
  ...
  />
    ...
    onChange={(key, val) => {
      ...
      executeSearch(void 0, void 0, { ...filters, [key]: val });
    }}
    onClear={() => {
      clearFilters();
      executeSearch(void 0, void 0, {
        cuisine: "",
        diet: "",
        mealType: "",
        maxReadyTime: void 0,
  ...
  />
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm font-bold text-stone-900">
                  {loading
                    ...
                    ? `${totalResults || searchResults.length} Recipes Found`
                    : "0 Recipes Found"}
                </span>
                {ingredients.length > 0 && <span className="text-xs text-stone-500 hidden sm:inline">
    ...
    /* Reset shortcut */
              ...
              {(filters.cuisine || filters.diet || filters.mealType || filters.maxReadyTime) && <button
    type="button"
    onClick={() => {
      clearFilters();
      executeSearch(void 0, void 0, {
